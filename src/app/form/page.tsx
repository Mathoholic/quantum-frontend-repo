...
const FormPage = () => {
  ...
  const checkUserFilledForm = async (customId: string) => {
    ...
    try {
      const response = await fetch(`https://api.quantumkids.in/form/enqueryForm/find?customId=${customId}`);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://api.quantumkids.in/form/enqueryForm', {
        method: 'POST',
        headers: {
