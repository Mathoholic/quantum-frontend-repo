...
const ContactInfo: React.FC = () => {
  return (
    <div className="flex justify-center items-center bg-[#E8F9FF]">
      <div className="lg:px-8 py-8 bg-white rounded-lg flex flex-row justify-between w-full lg:max-w-[1440px] gap-4 2xl:max-w-[2000px] 2xl:px-16 2xl:py-12">
        ...
        <div className="flex flex-col items-start gap-2 w-1/2">
          ...
          <div className="space-y-4 text-md text-gray-700 w-full relative font-outfit lg:text-3xl xl:text-[18px] font-medium leading-[32px] text-left 2xl:w-[550px] 2xl:text-[24px] 2xl:leading-[38px] lg:mt-8">
            ...
            <p className="flex items-start">
              <FaMapMarkerAlt className="mr-2 lg:mr-1 text-3xl 2xl:mr-4 2xl:text-4xl" />
              <span>
          ...
          <div className="flex space-x-4 text-pink-500 text-2xl 2xl:text-3xl 2xl:space-x-6 mt-8 lg:mt-auto">
        ...
        <div className="w-1/2 h-[600px] 2xl:h-[700px]">
          <iframe
            width="100%"
            height="100%"
            style={{ border: 0 }}
